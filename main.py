...
from networksecurity.entity.artifact_entity import DataIngestionArtifact, DataValidationArtifact, DataTransformationArtifact, ClassifationMetricArtifact, ModelTrainerArtifact
import sys
